...
interface ChatInterfaceProps {
  ...
  isThinking: boolean;
  onFinish?: () => void; // Optional finish handler
}

const ChatInterface: React.FC<ChatInterfaceProps> = ({ messages, onSendMessage, isThinking, onFinish }) => {
          ...
          <div className="flex justify-between items-center mb-2">
            ...
            <div className="flex items-center gap-3">
              ...
              {onFinish && (
                <button
                  onClick={onFinish}
                  className="bg-red-50 hover:bg-red-100 text-red-600 border border-red-200 px-3 py-1 rounded-lg text-xs font-bold transition-colors active:scale-95"
                >
                  Selesai
                </button>
              )}
